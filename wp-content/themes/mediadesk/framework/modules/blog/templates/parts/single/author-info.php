<?php
	$author_info_box = esc_attr(mediadesk_edge_options()->getOptionValue('blog_author_info'));
	$author_info_email = esc_attr(mediadesk_edge_options()->getOptionValue('blog_author_info_email'));

<div class="edgtf-news-item edgtf-masonry-layout-item edgtf-item-space <?php echo esc_attr( $post_info['class'] ) ?>">
	<div class="edgtf-ni-inner">
		<div class="edgtf-ni-image-holder">
			<?php echo edgtf_news_get_shortcode_inner_template_part( 'image', '', $post_info ); ?>

...
namespace EdgefNews\CPT\Shortcodes\Layout8;
...
class Layout8 extends Lib\NewsShortcodes {
	...
	function __construct() {
		$this->base            = 'edgtf_layout8';
		$this->css_class       = 'edgtf-layout8';
		$this->shortcode_title = esc_html__( 'Layout 8', 'edgtf-news' );
	...
	public function render( $atts, $content = null ) {
		...
		$html = edgtf_news_get_shortcode_module_template_part( 'templates/layout8-template', 'layout8', '', $params );

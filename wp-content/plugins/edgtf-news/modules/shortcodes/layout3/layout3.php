...
namespace EdgefNews\CPT\Shortcodes\Layout3;
...
class Layout3 extends Lib\NewsShortcodes {
	...
	function __construct() {
		$this->base            = 'edgtf_layout3';
		$this->css_class       = 'edgtf-layout3';
		$this->shortcode_title = esc_html__( 'Layout 3', 'edgtf-news' );
	...
	public function render( $atts, $content = null ) {
		...
		$html = edgtf_news_get_shortcode_module_template_part( 'templates/layout3-template', 'layout3', '', $params );

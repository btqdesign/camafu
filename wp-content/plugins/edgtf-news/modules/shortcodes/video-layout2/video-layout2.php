...
namespace EdgefNews\CPT\Shortcodes\VideoLayout2;
...
class VideoLayout2 extends Lib\NewsShortcodes {
	...
	function __construct() {
		$this->base            = 'edgtf_video_layout2';
		$this->css_class       = 'edgtf-video-layout2';
		$this->shortcode_title = esc_html__( 'Video Layout 2', 'edgtf-news' );
		$this->icon_class      = 'video-layout2';
	...
	public function render( $atts, $content = null ) {
		...
		if ( $params['has_video_link'] ) {
			...
			$html = edgtf_news_get_shortcode_module_template_part( 'templates/video-layout2-template', 'video-layout2', '', $params );
		}

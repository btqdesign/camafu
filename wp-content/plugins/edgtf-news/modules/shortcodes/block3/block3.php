...
namespace EdgefNews\CPT\Shortcodes\Block3;

use EdgefNews\Lib;

class Block3 extends Lib\NewsShortcodes {
	private $base;
	private $css_class;
	...
	function __construct() {
		$this->base            = 'edgtf_block3';
		$this->css_class       = 'edgtf-block3';
		$this->shortcode_title = esc_html__( 'Block 3', 'edgtf-news' );
		$this->icon_class      = 'block3';
	...
	public function render( $atts, $content = null ) {
		...
		if ( $atts['post_number'] == '1' ) {
			...
			$html .= edgtf_news_get_shortcode_module_template_part( 'templates/layout2-template', 'layout2', '', $featured_params );
		} else {
			//Get HTML from template

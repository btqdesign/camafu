...
namespace EdgefNews\CPT\Shortcodes\Layout9;

use EdgefNews\Lib;

class Layout9 extends Lib\NewsShortcodes {
	private $base;
	private $css_class;
	...
	function __construct() {
		$this->base            = 'edgtf_layout9';
		$this->css_class       = 'edgtf-layout9';
		$this->shortcode_title = esc_html__( 'Layout 9', 'edgtf-news' );
		$this->icon_class      = 'layout9';
	...
	public function render( $atts, $content = null ) {
		...
		$html = edgtf_news_get_shortcode_module_template_part( 'templates/layout9-template', 'layout9', '', $params );

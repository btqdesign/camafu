...
namespace EdgefNews\CPT\Shortcodes\Layout6;

use EdgefNews\Lib;

class Layout6 extends Lib\NewsShortcodes {
	private $base;
	private $css_class;
	...
	function __construct() {
		$this->base            = 'edgtf_layout6';
		$this->css_class       = 'edgtf-layout6';
		$this->shortcode_title = esc_html__( 'Layout 6', 'edgtf-news' );
		$this->icon_class      = 'layout6';

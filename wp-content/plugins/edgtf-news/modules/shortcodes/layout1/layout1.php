...
namespace EdgefNews\CPT\Shortcodes\Layout1;
...
class Layout1 extends Lib\NewsShortcodes {
	...
	function __construct() {
		$this->base            = 'edgtf_layout1';
		$this->css_class       = 'edgtf-layout1';
		$this->shortcode_title = esc_html__( 'Layout 1', 'edgtf-news' );
	...
	public function render( $atts, $content = null ) {
		...
		$html = edgtf_news_get_shortcode_module_template_part( 'templates/layout1-template', 'layout1', '', $params );

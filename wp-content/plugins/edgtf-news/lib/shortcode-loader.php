...
class ShortcodeLoader {
	 ...
	 */
	private function addShortcode( NewsShortcodes $shortcode ) {
	...
	private function addShortcodes() {
		$shortcodes_class_name = apply_filters( 'edgtf_news_filter_add_vc_shortcode', $shortcodes_class_name = array() );

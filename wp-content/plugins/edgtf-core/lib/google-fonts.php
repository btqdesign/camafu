<?php
if ( ! function_exists( 'mediadesk_edge_init_google_fonts_array' ) ) {
    function mediadesk_edge_init_google_fonts_array() {
        ...
        $mediadesk_edge_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'mediadesk_edge_init_google_fonts_array');
}
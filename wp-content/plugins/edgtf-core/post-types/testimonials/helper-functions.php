...
if ( ! function_exists( 'edgtf_core_testimonials_meta_box_functions' ) ) {
	...
	add_filter( 'mediadesk_edge_filter_meta_box_post_types_save', 'edgtf_core_testimonials_meta_box_functions' );
	add_filter( 'mediadesk_edge_filter_meta_box_post_types_remove', 'edgtf_core_testimonials_meta_box_functions' );
}

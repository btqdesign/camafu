...
class EdgefCoreImport {
    ...
    public function import_options($file){
        $options = $this->file_options($file);
        $result = update_option( 'edgtf_options_mediadesk', $options);
    ...
    function edgtf_admin_import() {
        if (edgtf_core_theme_installed()) {
            ...
            $this->pagehook = add_submenu_page(
                ...
                array($mediadesk_edge_global_Framework->getSkin(), 'renderImport')
            );

            add_action('admin_print_scripts-'.$this->pagehook, 'mediadesk_edge_enqueue_admin_scripts');
            add_action('admin_print_styles-'.$this->pagehook, 'mediadesk_edge_enqueue_admin_styles');
        }
    }
}
...
class Banner implements Lib\ShortcodeInterface {
				...
				array(
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Image Overlay Color', 'edgtf-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'hover_behavior',
							'heading'     => esc_html__( 'Hover Behavior', 'edgtf-core' ),
							'value'       => array(
								esc_html__( 'Visible on Hover', 'edgtf-core' )   => 'edgtf-visible-on-hover',
								esc_html__( 'Visible on Default', 'edgtf-core' ) => 'edgtf-visible-on-default',
								esc_html__( 'Disabled', 'edgtf-core' )           => 'edgtf-disabled'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Info Position', 'edgtf-core' ),
							'value'       => array(
								esc_html__( 'Default', 'edgtf-core' )  => 'default',
								esc_html__( 'Centered', 'edgtf-core' ) => 'centered'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Info Content Padding', 'edgtf-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left', 'edgtf-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'subtitle',
						...
						array(
							...
							'heading'    => esc_html__( 'Link Text Color', 'edgtf-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'link_top_margin',
							'heading'    => esc_html__( 'Link Text Top Margin (px)', 'edgtf-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						)
					)
				)
	...
	private function getTitleStyles( $params ) {
		...
		if ( ! empty( $params['title_top_margin'] ) ) {
			$styles[] = 'margin-top: ' . mediadesk_edge_filter_px( $params['title_top_margin'] ) . 'px';
		}
	...
	private function getLinkStyles( $params ) {
		...
		if ( ! empty( $params['link_top_margin'] ) ) {
			$styles[] = 'margin-top: ' . mediadesk_edge_filter_px( $params['link_top_margin'] ) . 'px';
		}

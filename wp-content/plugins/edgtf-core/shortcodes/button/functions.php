...
if ( ! function_exists( 'mediadesk_edge_get_button_html' ) ) {
	/**
	 ...
	 * @return mixed|string
	 */
	function mediadesk_edge_get_button_html( $params ) {
		$button_html = mediadesk_edge_execute_shortcode( 'edgtf_button', $params );
